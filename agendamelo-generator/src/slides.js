...
const SLIDE_CSS = `
.content.slide { justify-content: space-between; padding-top: 30px; padding-bottom: 14px; }
.brand.compact { margin-bottom: 0; gap: 16px; }
.brand.compact .mark { width: 78px; height: 78px; }
.brand.compact .wm { font-size: 58px; }
.brand.compact .tag { font-size: 16px; letter-spacing: 5px; margin-top: 3px; }

/* indicador de páginas */
.dots-nav { display: flex; gap: 14px; justify-content: center; margin-top: 12px; }
.dots-nav i { width: 15px; height: 15px; border-radius: 50%; background: var(--line); display: block; }
.dots-nav i.on { background: var(--accent); width: 44px; border-radius: 999px; }

/* lista de viñetas (compartida punto/cierre) */
.s-list { display: flex; flex-direction: column; gap: 22px; }
.s-li { display: flex; align-items: flex-start; gap: 20px; font-size: 38px; line-height: 1.3;
  font-weight: 500; color: var(--ink); }
.s-li-ic { flex: 0 0 auto; width: 50px; height: 50px; border-radius: 14px; color: #fff;
  background: var(--grad-accent); display: grid; place-items: center; margin-top: 2px; }
...
.sp-hook { font-family: 'Bricolage Grotesque',sans-serif; font-weight: 800; font-size: 104px;
...
.sp-sub { font-size: 40px; line-height: 1.35; color: var(--body); font-weight: 500; max-width: 92%; }
...
.cl-title { font-family: 'Bricolage Grotesque',sans-serif; font-weight: 800; font-size: 70px; line-height: 1.04;
...
.cl-text { font-size: 38px; line-height: 1.38; color: var(--body); text-align: center; }
...
.cl-cta { display: flex; align-items: center; gap: 22px; background: var(--grad-accent); border-radius: 28px;
  padding: 32px 38px; box-shadow: 0 18px 40px var(--accent-soft); margin-top: 6px; }
.cl-cta .ic { flex: 0 0 auto; width: 70px; height: 70px; display: grid; place-items: center;
  background: rgba(255,255,255,0.18); border-radius: 20px; }
.cl-cta .tx { color: #fff; }
.cl-cta .tx b { font-family: 'Bricolage Grotesque',sans-serif; font-weight: 700; font-size: 44px; display: block; line-height: 1.1; }
.cl-cta .tx span { font-size: 30px; opacity: 0.94; display: block; margin-top: 6px; }
`;
