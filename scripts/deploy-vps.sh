...
if [ "$ENABLE_YOUTUBE" = true ]; then
  ...
  set_env YOUTUBE_SCENE_SECONDS 3.4
  set_env YOUTUBE_TRANSITION_SECONDS 0.22
  set_env YOUTUBE_TRANSITION_HOLD_SECONDS 0.02
  set_env YOUTUBE_TRANSITION_SHIFT_PIXELS 18
  set_env YOUTUBE_MUSIC_VOLUME 0.22
  set_env YOUTUBE_DUCKING_LEVEL 0.65
  set_env YOUTUBE_INTRO_DUCKING_LEVEL 0.50
  set_env YOUTUBE_LOUDNESS_TARGET -16
  set_env YOUTUBE_TRUE_PEAK -1.5
  set_env YOUTUBE_SFX_ENABLED true
  set_env YOUTUBE_INTRO_SFX_SECONDS 0.62
  set_env YOUTUBE_INTRO_SFX_VOLUME 0.72
  set_env YOUTUBE_TRANSITION_SFX_SECONDS 0.20
  set_env YOUTUBE_TRANSITION_SFX_VOLUME 0.055
  set_env YOUTUBE_OUTRO_SFX_SECONDS 0.72
  set_env YOUTUBE_OUTRO_SFX_VOLUME 0.17
fi
